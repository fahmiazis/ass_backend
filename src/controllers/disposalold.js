      ...
      if (result) {
        if (form === 'editdis' && result.length > 0) {
          ...
          for (let i = 0; i < result.length; i++) {
            if (result[i].no_persetujuan !== null) {
                      ...
                      if (sent) {
                        ...
                        if (findDis.length > 0) {
                          ...
                          if (cekdok.length > 0) {
                            const cekDis = []
                            for (let i = 0; i < findDis.length; i++) {
                              const stat = dokarea.length > 0 && dokpurch.length > 0 ? 3 : dokarea.length === 0 && dokpurch.length > 0 ? 2 : dokarea.length > 0 && dokpurch.length === 0 ? 1 : 1
                              const data = {
                                status_reject: stat
                              }
                              const send = {
      ...
      try {
        ...
        if (result) {
          ...
          if (tipe === 'edit' && ket === 'peng') {
            ...
            if (findDis.no_persetujuan === null) {
