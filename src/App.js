...
const tempmailRoute = require('./routes/tempmail')
...
const newnotifRoute = require('./routes/newnotif')
...
app.use('/tempmail', authMiddleware, tempmailRoute)
app.use('/dokumen', authMiddleware, dokumenRoute)
app.use('/asset', authMiddleware, assetRoute)
app.use('/ticket', authMiddleware, pengadaanRoute)
...
app.use('/newnotif', authMiddleware, newnotifRoute)
